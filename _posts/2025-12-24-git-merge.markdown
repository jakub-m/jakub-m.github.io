...
Here is a git tick I use to spare myself resolving conflicts on repositories
...
At this point `feat_2` "knows" that it contains changes from `main` and from_1,
so now the merge-squash into `main` will pass without conflicts.
